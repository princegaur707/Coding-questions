...
#Using *args as a function parameter enables  to pass an arbitrary number of arguments to that function.
#The arguments are then accessible as the tuple args in the body of the function.

#**kwargs (standing for keyword arguments) allows  to handle named arguments {that we have not defined in advance}.
